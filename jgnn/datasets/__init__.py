...
Shared HDF5 I/O utilities plus two dataset streams:
  ...
  cartesian  — 3-D Cartesian phase-space (sample_galaxies.py output)
               pos=(x,y,z), vel=(vx,vy,vz), x=[log10(r), ||v||]
...
# ---------------------------------------------------------------------------
# Backward-compatible top-level imports from the Cartesian stream
# ---------------------------------------------------------------------------

prepare_dataloaders = cartesian.prepare_dataloaders
prepare_test_dataloader = cartesian.prepare_test_dataloader
