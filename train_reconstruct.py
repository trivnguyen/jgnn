...
import datasets
from jgnn import models, simple_npe, utils
...
def train(
    ...
    train_loader, val_loader, norm_dict = datasets.prepare_dataloaders_recon(
        ...
        num_subsampling=config.num_subsampling, num_workers=config.num_workers,
        seed=config.seed_data
    )

    # create model
    model = simple_npe.SimpleNPE(
        input_size=config.model.input_size,
        output_size=config.model.output_size,
        mlp_args=config.model.mlp_args,
        flows_args=config.model.flows_args,
